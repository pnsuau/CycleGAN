...
from image_folder import make_dataset, make_labeled_mask_dataset, make_dataset_path
...
class UnalignedLabeledMaskDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.B_paths = sorted(make_dataset_path(self.dir_B,'/paths.txt', opt.max_dataset_size))    # load images from '/path/to/data/trainB'
    ...
    def __getitem__(self, index):
        ...
        return {'A': A, 'B': B, 'A_paths': A_img_path, 'B_paths': B_path, 'A_label': A_label}
