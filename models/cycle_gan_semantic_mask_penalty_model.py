...
class CycleGANSemanticMaskPenaltyModel(BaseModel):
    #def name(self):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_mask', type=float, default=10.0, help='weight for loss out mask')
            parser.add_argument('--loss_mask', type=str, default='L1', help='loss mask')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 
                'D_B', 'G_B', 'cycle_B', 'idt_B',
                           'sem_AB', 'sem_BA', 'f_s', 'mask_AB','mask_BA'
        ]
        ...
        visual_names_seg = ['input_A_label','gt_pred_A','pfB_max','gt_pred_B','pfA_max','real_A_out_mask','fake_B_out_mask','real_B_out_mask','fake_A_out_mask']
        ...
        if self.isTrain:
            ...
            self.netD_A = networks.define_D(opt.output_nc, opt.ndf,
                                            opt.netD,
                                            opt.n_layers_D, opt.norm, #use_sigmoid, xs
    ...
    def backward_G(self):
        ...
        self.loss_mask_AB = self.criterionMask( self.real_A_out_mask, self.fake_B_out_mask) * lambda_mask
        self.loss_mask_BA = self.criterionMask( self.real_B_out_mask, self.fake_A_out_mask) * lambda_mask
