...
class CycleGANSemanticMaskModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        visual_names_A = ['real_A', 'fake_B', 'rec_A','input_A_label','gt_pred_A']

        visual_names_B = ['real_B', 'fake_A', 'rec_B','gt_pred_B']
    ...
    def forward(self):
        ...
        if self.isTrain:
           ...
           #print('pred_real_B',pred_real_B[0])
           #print('self.input_A_label',self.input_A_label[0])
#           print('gt_pred_B',self.gt_pred_B[0][1])
#           print('gt_pred_B',self.gt_pred_B[0][2])
#           print('gt_pred_B',self.gt_pred_B[0][3])
#           print('gt_pred_B',self.gt_pred_B[0][4])
#           print('gt_pred_B',self.gt_pred_B[0][5])
           #print('pred_real_B shape',pred_real_B.shape)
           #print('gt_pred_B shape',self.gt_pred_B.shape)
...
#        print('self.pred_fake_B',self.pred_fake_B[0][0])
#        print('self.pred_fake_B',self.pred_fake_B[0][1])
#        print('self.pred_fake_B',self.pred_fake_B[0][2])
#        print('self.input_A_label',self.input_A_label[0][0])
#        print('self.input_A_label',self.input_A_label[0][1])
#        print('self.input_A_label',self.input_A_label[0][2])
#        for i in self.input_A_label[0][0]:
#            for j in i:
#                print(j)

        #print('input label squeeze',self.input_A_label.squeeze(1))
        #print('pfB',self.pfB)
        #print('pfA',self.pfA)
        #print('pfB',self.pfB.shape)
        #print('pfA',self.pfA.shape)
        #print('self.gt_pred_B',self.gt_pred_B)
#        for k in self.input_A_label.squeeze(1):
...
#                        print(self.image_paths)
        ...
        #print('self.loss_sem_AB',self.loss_sem_AB)
        ...
        #print('self.criterionf_s',self.criterionf_s)
        ...
        #print('self.loss_sem_AB',self.loss_sem_AB)
        #print('self.loss_sem_BA',self.loss_sem_BA)
